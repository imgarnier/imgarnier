(function() {
    ...
    window.rgbKineticSliderMobile = function(options) {
        ...
        options = options || {};
        options.slideImages2 = options.hasOwnProperty('slideImages2') ? options.slideImages2 : [];
        ...
        options.images2RgbEffect = options.hasOwnProperty('images2RgbEffect') ? options.images2RgbEffect : false; 
        ...
        options.images2RgbIntensity = options.hasOwnProperty('images2RgbIntensity') ? options.images2RgbIntensity : 0.9;
        options.navImages2RgbIntensity= options.hasOwnProperty('navImages2RgbIntensity') ? options.navImages2RgbIntensity : 100;
        ...
        const canvas = document.getElementById("rgbKineticSliderMobile");
        const stage = new PIXI.Container();
        const mainContainer = new PIXI.Container();
        const images2Container = new PIXI.Container();
        ...
        function build_scene() {
            ...
            if( (options.images2RgbEffect == true) && (options.cursorImgEffect == true ) ) {
                

                if(options.cursorImgEffect  == true) {
                    images2Container.filters = [dispFilter_2, splitRgbImgs];
                    
                    
                }

                else {
                    images2Container.filters = [splitRgbImgs];
                ...
                if(options.cursorImgEffect  == true) {
                    images2Container.filters = [dispFilter_2];
            ...
            mainContainer.addChild(images2Container, textsContainer, textsSubContainer, dispSprite_2);
        ...
        function build_imgs() {
            ...
            for (let i = 0; i < options.slideImages2.length; i++) {
                
                // get texture from image
                texture = new PIXI.Texture.from(options.slideImages2[i]);
                ...
                images2Container.addChild(imgSprite);
            }

            slideImages2 = images2Container.children;
        }
        ...
        function slideTransition(next) {
            ...
            timelineTransition = new TimelineMax({
                ...
                onComplete: function() {
                    ...
                    if(options.images2RgbEffect == true) {
                        splitRgbImgs.red = [0, 0];
                        splitRgbImgs.green = [0, 0];
                        splitRgbImgs.blue = [0, 0];
                    }
                    ...
                    if( is_loaded === true) {
                        ...
                        if(options.textsRgbEffect == true) {
                            ...
                            if(timelineTransition.progress() < 0.8) {
                                ...
                                const passwordfade = document.getElementById("f1");
                                function delay() {
                                    passwordfade.style.opacity = "0";
                                }
                                setTimeout(delay, 500);     
                                
                                 /*  Fade Out Title Text*/
                                const textFade = document.getElementById("text-content");
                                function delay2() {
                                    textFade.style.opacity = "0";
                                }
                        ...
                        if(options.images2RgbEffect == true) {
                            ...
                            if(timelineTransition.progress() < 0.5) {
                                splitRgbImgs.red = [-timelineTransition.progress() * options.navImages2RgbIntensity, 0];
                                splitRgbImgs.green = [0, 0];
                            ...
                            // match splitRgb values with timeline progress / from x to 0
                                ...
                                splitRgbImgs.red = [-(options.navImages2RgbIntensity - timelineTransition.progress() * options.navImages2RgbIntensity), 0];
                                splitRgbImgs.green = [0, 0];
                                splitRgbImgs.blue = [( (options.navImages2RgbIntensity - timelineTransition.progress() * options.navImages2RgbIntensity)), 0];
            ...
            if( (options.textsSubTitleDisplay  == true) && (options.textsDisplay == true) && (options.itemsTitles.length > 0) ) {
                ...
                timelineTransition
                    ...
                    .to([slideImages2[currentIndex], slideTexts[currentIndex], slideTextsSub[currentIndex]], options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to([slideImages2[next], slideTexts[next], slideTextsSub[next]], options.slideTransitionDuration, {
                            alpha: 10,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to(dispFilter.scale, options.slideTransitionDuration, {
            ...
            // if subtitles inactive and title active
                ...
                timelineTransition
                    ...
                    .to([slideImages2[currentIndex], slideTexts[currentIndex]], options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to([slideImages2[next], slideTexts[next]], options.slideTransitionDuration, {
                            alpha: 1,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.5)
                    .to(dispFilter.scale, options.slideTransitionDuration, {
                ...
                timelineTransition
                    ...
                    .to(slideImages2,  options.slideTransitionDuration, {
                            alpha: 0,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.9)
                    .to([slideImages2[next]], options.slideTransitionDuration, {
                            alpha: 1,
                            ease: Power2.easeOut
                        }, options.slideTransitionDuration * 0.9)
                    .to(dispFilter.scale, options.slideTransitionDuration, {
        ...
        function mainLoop() {
            ...
            if (is_swipping) {
                ...
                if(options.images2RgbEffect == true) {
                    splitRgbImgs.red = [(kineX * options.images2RgbIntensity), 0];
                    splitRgbImgs.green = [0, 0];
                    splitRgbImgs.blue = [(-kineX * options.images2RgbIntensity), 0];
                } 
            }
        }
                ...
                function onDragMove() {
                    ...
                    if (is_swipping) {
                        ...
                        if ((drag_start.x - newPosition.x) < - options.swipeDistance) {
                            if (currentIndex >= 0 && currentIndex < options.slideImages2.length - 1) {
                        ...
                        if ((drag_start.x - newPosition.x) > options.swipeDistance) {
                            if (currentIndex > 0 && currentIndex < options.slideImages2.length) {
                                slideTransition(currentIndex - 1);
                            } else {
                                slideTransition(options.slideImages2.length - 1);
                            }
                        }
                    }
                }
            ...
            for (let i = 0; i < nav.length; i++) {
                ...
                navItem.onclick = function(event) {
                    ...
                    if (this.getAttribute('data-nav') === 'next') {
                        if (currentIndex >= 0 && currentIndex < options.slide2.length - 1) {
                            slideTransition(currentIndex + 1);
                        } else {
                            slideTransition(0);
                        }
        ...
        window.WebFontConfig = {
            ...
            active: function() { 
                ...
                images2Loaded(images2, function() {
